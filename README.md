...
## ✨ Features
🎮 **Game Collection Management** - Add, remove, and organize your Nintendo Switch games with an intuitive interface

🖼️ **Automatic Artwork Fetching** - High-quality box art automatically loaded from IGDB when adding games
...
## 🚀 Live Demo
<a href="https://switch-game-library.netlify.app/">Try it now!</a>
